...
if(dropbtn.style.transform=="translateY(300%) rotate(180deg)"){
history.style.height="21.8%";
document.querySelector(".value").style.height="100%";
dropbtn.style.transform="translateX(0) translateY(300%) rotate(-360deg)";
history.style.overflow="hidden";
document.calc.small.style.opacity="1";
}
else{
history.style.height="99%";
document.querySelector(".value").style.height="13%";
dropbtn.style.transform="translateY(300%) rotate(180deg)";
